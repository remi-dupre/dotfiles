" Custom color scheme based on atom-dark-256
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi Special term=bold cterm=NONE ctermbg=234 ctermfg=202 gui=NONE guibg=bg guifg=#66D9EF
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=156 gui=NONE guibg=bg guifg=#A8FF62
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Special term=bold cterm=NONE ctermbg=80 ctermfg=202 gui=NONE guibg=bg guifg=#66D9EF
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
